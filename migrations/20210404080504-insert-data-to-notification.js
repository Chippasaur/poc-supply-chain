    ...
    try {
      for (let i = 0; i < 10; i++) {
        await db.insert('notifications', {
          ...
          type: i % 5,
          createTime: new Date('2021-1-23 16:00:00 UTC'),
        })
      }
      for (let i = 0; i < 10; i++) {
        await db.insert('notifications', {
          ...
          type: i % 5,
          createTime: new Date('2021-2-23 16:00:00 UTC'),
        })
      }
      for (let i = 0; i < 10; i++) {
        await db.insert('notifications', {
          ...
          type: i % 5,
          createTime: new Date('2021-2-2 16:30:00 UTC'),
        })
      }
      for (let i = 0; i < 10; i++) {
        await db.insert('notifications', {
          ...
          type: i % 5,
          createTime: new Date('2021-2-10 8:00:00 UTC'),
        })
      }
    } catch (error) {
